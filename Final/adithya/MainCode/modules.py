...
# This Section implements the Induced Self-Attention Block (ISAB) and Pooling Multi-head Attention (PMA) for the Set transformer architecture.
...
class SetTransformer(nn.Module):
    def __init__(self, dim_input, num_outputs, dim_output,
        ...
        self.dec = nn.Sequential(
                ...
                nn.Linear(dim_output, num_outputs)
                )
